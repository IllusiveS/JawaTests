...
public class BookManager {
	...
	private static final String CREATE_TABLE_BOOK =
			"CREATE TABLE Book(id bigint PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY, name varchar(20), author varchar(30), yor integer, person_id bigint FOREIGN KEY REFERENCES Person(id))";

	private static final String CREATE_TABLE_PERSON =
			"CREATE TABLE Person(id bigint PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY, name varchar(20), yob integer)";
